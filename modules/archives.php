<div class="filter scroll-follow">
	<input class='form-input' id='filter_type' type='hidden' value='filters_archived_assets'>
	<div class="form">
		<div class="form-group form-group-inline">
			<div class="form-element form-element-extended">
				<label class="form-label" for="search">Rechercher un matériel</label>
				<input autofocus onfocus="this.setSelectionRange(this.value.length,this.value.length);" value="<?= Filter::find("filters_archived_assets", "search"); ?>" class="form-input filter-search" type='text' id="search" name="search" placeholder='Rechercher un matériel (par nom, remarque, attribution, numéro de série)' />
			</div>
		</div>
		<div class="form-section">
			<div class="form-element">
				...
				<select class='form-select filter-select' id="statut">
					...
					<?= Select::statuses(key: "filters_archived_assets", archive: "only"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="marque">
					<option value='all'>Tous</option>
					<?= Select::manufacturers(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="modele">
					<option value='all'>Tous</option>
					<?= Select::models(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="os">
					<option value='all'>Tous</option>
					<?= Select::os(key: "filters_archived_assets", versions: false); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="os_version">
					<option value='all'>Tous</option>
					<?= Select::os(key: "filters_archived_assets", versions: true); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="type">
					<option value='all'>Tous</option>
					<?= Select::types(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="localisation">
					<option value='all'>Tous</option>
					<?= Select::locations(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="statut_ad">
					<option value='all'>Tous</option>
					<?= Select::activeDirectoryStatuses(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="clavier">
					...
					<?= Select::keyboardTypes(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="langue">
					<option value='all'>Toutes</option>
					<?= Select::systemLanguages(key: "filters_archived_assets"); ?>
				</select>
			</div>
			<div class="form-element">
				...
				<select class='form-select filter-select' id="type_achat">
					<option value='all'>Tous</option>
					<?= Select::acquisitionTypes(key: "filters_archived_assets"); ?>
				</select>
			</div>
		</div>
		<div class="form-group form-action">
			...
			<div class="form-action-uo">
				<div class="form-element">
					<a href="./tools/exports/assets.php?archived=true">
...
<div id='filters_archived_assets'>
	<?= Table::assets(archived: true); ?>
</div>